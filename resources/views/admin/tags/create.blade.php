...
@section('page_title', __('Create Tag'))
...
<div class="mb-8 flex items-center gap-4">
    ...
    <div>
        <h3 class="text-xl font-bold tracking-tight text-white">{{ __('Define Label') }}</h3>
        <p class="text-sm text-slate-400">{{ __('Create a new identifier to help customers find related products.') }}</p>
    </div>
</div>
    ...
    <div class="max-w-xl mx-auto">
        <div class="glass p-8 rounded-[2rem] shadow-2xl border border-white/5 space-y-8">
            ...
            <div class="space-y-2">
                ...
                <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="{{ __('e.g. Special Edition') }}" required
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center gap-4 p-4 bg-white/5 rounded-2xl border border-white/10">
                    ...
                    <div class="flex flex-col">
                        ...
                        <p class="text-xs text-slate-400 font-medium">{{ __('This color will be used as a visual indicator for this tag.') }}</p>
                    </div>
                </div>
