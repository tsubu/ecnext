            ...
            <div class="lg:col-span-1 space-y-8">
                <div class="glass p-8 rounded-[2.5rem] border border-white/5 shadow-2xl space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name', $block_type->name ?? '') }}" required placeholder="e.g. Hero Section"
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="type_key" id="type_key" value="{{ old('type_key', $block_type->type_key ?? '') }}" required placeholder="e.g. hero"
